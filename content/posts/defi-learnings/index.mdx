...
always prefer the fully decentralized platform; coinswitch, zebpay, blockfi are still centralized; AAVE, Trezor is fully centralized

use metamask for the gibberish that Richard Garcia does in the video;
