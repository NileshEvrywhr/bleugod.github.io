...
tags:
  ...
  - crypto
  - web3
banner: "./pexels-tima-miroshnichenko-6914639.jpg"
---

![replace this](./pexels-tima-miroshnichenko-6914639.jpg)

---

everything long term, that defines the working of dApps, blockchains, and crypto projects — concepts that will never change; only built upon using — these are my notes on ideas and concepts I found valueable in understanding how things work in Web3 — not a comprehensive explaination — will be updating it as I learn more —
...
2 tokens - governance token & currency token
